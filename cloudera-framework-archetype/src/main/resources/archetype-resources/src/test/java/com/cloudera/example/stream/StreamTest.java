...
import com.cloudera.framework.testing.LocalClusterDfsMrFlumeTest;
...
public class StreamTest extends LocalClusterDfsMrFlumeTest implements TestConstants {
  ...
  public void testStream() throws IOException, EventDeliveryException, InterruptedException {
    ...
    Assert.assertEquals(Driver.RETURN_SUCCESS, driverProcess.runner(
        new String[] { getPathString(DIR_ABS_MYDS_PARTITIONED_CANONICAL), getPathString(DIR_ABS_MYDS_PROCESSED) }));
