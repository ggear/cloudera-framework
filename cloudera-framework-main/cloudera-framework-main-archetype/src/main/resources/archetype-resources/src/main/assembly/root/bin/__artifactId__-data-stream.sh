...
$ROOT_DIR/bin/*-shell-hadoop.sh "fs -mkdir -p $ROOT_DIR_HDFS_STAGED_CANONICAL/text/$RECORD_FORMAT/none"
$ROOT_DIR/bin/*-shell-hadoop.sh "fs -chmod 777 $ROOT_DIR_HDFS_STAGED_CANONICAL/text/$RECORD_FORMAT/none"
