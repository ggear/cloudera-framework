...
public class RecordFormatText extends CombineFileInputFormat<RecordKey, Text> {
  ...
  public RecordReader<RecordKey, Text> createRecordReader(InputSplit split, TaskAttemptContext context)
      throws IOException {
    return new CombineFileRecordReader<RecordKey, Text>((CombineFileSplit) split, context, RecordReaderCsv.class);
  }

  public static class RecordReaderCsv extends RecordReader<RecordKey, Text> {

    private static final Log LOG = LogFactory.getLog(RecordReaderCsv.class);
    ...
    public RecordReaderCsv(CombineFileSplit split, TaskAttemptContext context, Integer index) throws IOException {
