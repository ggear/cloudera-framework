...
Alternatively, the module can be distributed as a binary by copying the dependencies (eg [cloudera-framework-1.2.1-cdh5.4.7](https://github.com/ggear/cloudera-framework/tree/cloudera-framework-1.2.1-cdh5.4.7/cloudera-framework-repo/cloudera-framework-repo-external/src/main/repository) into a shared lib (eg, [cloudera-cyclehire](https://github.com/ggear/cloudera-cyclehire)).
...
```bash
export CF_VERSION_RELEASE=1.2.1
export CDH_VERSION_RELEASE=5.4.7
export CF_VERSION_HEAD=1.2.2
export CDH_VERSION_HEAD=5.4.7
mvn clean
